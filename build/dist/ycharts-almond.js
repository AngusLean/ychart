 ...
 */
define('base/transform',['require','./../tool/matrix','./../tool/vector'],function(require) {
 ...
 */
define('base/eventful',['require'],function (require) {
 ...
 */
define('base/draggable',['require','./eventful','../tool/util'],function(require){
    ...
    util.ClassUtil.mixin(Draggable, EventUtil, true);
    
    return Draggable;

});
define('base/element',['require','../tool/util','../tool/guid','./transform','./eventful','./draggable'],function (require) {
...
define('tool/event',['require'],function (require) {
 ...
 */
define('Handler',['require','./tool/event','./tool/util','./base/draggable'],function(require){
...
define('Ycharts',['require','./tool/util','./Storage','./Painter','./Handler','./Group'],function(require) {
...
define('shape/dep/shapeutil',['require'],function(require){
...
define('tool/text',['require','../shape/dep/style','../shape/dep/shapeutil'],function(require) {
...
define('shape/dep/OptionProxy',['require','./styleProxy','../../tool/util'],function (require) {
...
define( 'shape/dep/BaseShape',['require','../../tool/util','../../tool/debug','../../tool/text','../../base/element','./OptionProxy','./shapeutil'],function (require) {
...
define('shape/ShapeBuilder',['require','./dep/BaseShape','../tool/util'],function(require){
...
define('shape/Bezier',['require','../tool/util','../tool/debug','./ShapeBuilder'],function(require){
...
define('shape/Circle',['require','./dep/shapeutil','./ShapeBuilder'],function(require){
...
define('shape/Line',['require','./ShapeBuilder'],function(require){
...
define('shape/Rect',['require','./ShapeBuilder'],function(require){
...
define('shape/Triangle',['require','./ShapeBuilder'],function(require){
...
define('shape/YText',['require','../tool/util','../tool/text','./ShapeBuilder'],function(require){
